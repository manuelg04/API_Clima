...
function mostrarError(mensaje){
    ...
    if(!alerta){
        ...
        <strong clsas="font-bold"> Error!</strong>
...
function consultarAPI(ciudad, pais){
    const appId= "6307ee00d24580ab6c937602c7d264c2";
...
function mostrarClima(datos){
    ...
    nombreCiudad.classList.add("font-bold", "text.5xl")
